...
# Interative map of 1807RL sampling

Planned compulsory (blue), adaptive (red), marine mammal (green), Saildrone (orange), and UCTD (gray) stations/transects. Waypoint info can be found in the tables below the map.
