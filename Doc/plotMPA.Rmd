...
pkgs <- c("tidyverse","swfscMisc","lubridate","sp","rgeos","sp","maptools",
          ...
          "RODBC","kableExtra","rnaturalearth","shadowtext","here","mapview")
...
mapview(ca_waters, alpha = 0.7, alpha.region = 0.1, layer.name = "CA State Waters") +
  ...
  mapview(tx.mapview, color = "black", alpha = 0.5,layer.name = "Transects") +
  mapview(wpt.mapview, zcol = "Type", cex = 4, col.regions = c("red","blue","green","orange","yellow"),
          layer.name = "Transect Waypoints") +
  mapview(wpt.uctd, color = "black", cex = 2, fill = "black", layer.name = "UCTD Stations")
```
